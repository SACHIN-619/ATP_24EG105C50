...
function WriteArticles() {
  ...
  const submitArticle = async (articleObj) => {
    ...
    try {
      ...
      if (res.status === 201) {
        toast.success("Article published successfully",{duration:4000})
        navigate("../articles");
...
//      setLoading(true)
//      //make post req to  save new article
//      let res = await axios.post("http://localhost:4000/author-api/article", articleObj,{withCredentials:
//         //navigate to authorarticles
//         if(res.status==201){
//             navigate("../articles")
//             //navigate("./author-proile/articles")
//         }
//      })
//     } catch (err) {
//     //   toast.error(err.response?.data?.error || "Failed to publish article");
