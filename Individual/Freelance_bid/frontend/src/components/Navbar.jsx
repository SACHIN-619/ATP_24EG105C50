...
//             </svg>
//           </div>
//           <span style={{ fontFamily: '"Playfair Display", serif', fontSize: 18, fontWeight: 600, color: 'var(--text-primary)', letterSpacing: '-0.3px' }}>
//             Bid<span style={{ color: 'var(--accent)' }}>Portal</span>
//           </span>
//         </Link>
...
//               {/* Avatar */}
//               <div onClick={() => navigate(`/profile/${user._id}`)} title="Profile" style={{
...
//               <span style={{ fontSize: 13, color: 'var(--text-secondary)', fontWeight: 500, maxWidth: 100, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
//                 {user.name}
//               </span>
...
//                 marginLeft: 4, fontFamily: '"DM Sans", sans-serif', transition: 'background 0.15s',
//               }}
//                 onMouseEnter={e => e.currentTarget.style.background = 'var(--accent-hover)'}
//                 onMouseLeave={e => e.currentTarget.style.background = 'var(--accent)'}
//               >Get Started</Link>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          <Link to="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 32, height: 32, background: 'var(--accent)', borderRadius: 8, display: 'flex', alignItems: 'center', justifycontent: 'center' }}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ margin: 'auto' }}>
                <path d="M2 12L6 4L10 9L12 6L14 12H2Z" fill="white" strokeLinejoin="round"/>
              </svg>
            </div>
            <span style={{ fontFamily: '"Playfair Display", serif', fontSize: 19, fontWeight: 600, color: 'var(--text-primary)', letterSpacing: '-0.3px' }}>
              Bid<span style={{ color: 'var(--accent)' }}>Portal</span>
            </span>
          </Link>
        ...
        {/* Right Side: Identity, Notifications, Actions */}
            ...
            <>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ 
                  ...
                  {user.name.split(' ')[0]} {/* Keeps layout narrow by grabbing the first name */}
                </span>
              </div>
